...
public final class Constants {
    ...
    public static final String KEY_POWER_MODE = "com.digiwiz.geofence.KEY_POWER_MODE";
    public static final String KEY_UPDATE_INTERVAL = "com.digiwiz.geofence.KEY_UPDATE_INTERVAL";

    public static final String KEY_SHOW_COORDINATES_NOTIFICATION = "com.digiwiz.geofence.KEY_SHOW_COORDINATES_NOTIFICATION";

    public static final String KEY_SHOW_GEOFENCE_NOTIFICATION = "com.digiwiz.geofence.KEY_SHOW_GEOFENCE_NOTIFICATION";

    public static final String KEY_ENTER_GEOFENCE_URL = "com.digiwiz.geofence.KEY_ENTER_GEOFENCE_URL";
    public static final String KEY_EXIT_GEOFENCE_URL = "com.digiwiz.geofence.KEY_EXIT_GEOFENCE_URL";
    public static final String LOG_TAG = "GeoFence";
